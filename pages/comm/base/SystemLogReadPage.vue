...
export default {
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        { field: 'userNo',      editable: false, title: '사용자NO',   width: this.setPercentage("divWrapper",25)},
        { field: 'userLoginId', editable: false, title: '사용자ID',   width: this.setPercentage("divWrapper",25)},
        { field: 'userNm',      editable: false, title: '사용자명',   width: this.setPercentage("divWrapper",25)},
        { field: 'loginDttm',   editable: false, title: '로그인일시', width: this.setPercentage("divWrapper",25)}
      ];

      this.columns2 = [
        { field: 'userNo',        editable: true, title: '사용자NO',      width: this.setPercentage("divWrapper",20)},
        { field: 'userLoginId',   editable: true, title: '사용자ID',      width: this.setPercentage("divWrapper",20)},
        { field: 'userNm',        editable: true, title: '사용자명',       width: this.setPercentage("divWrapper",20)},
        { field: 'menuNm',        editable: true, title: '메뉴명',        width: this.setPercentage("divWrapper",20)},
        { field: 'menuCnctDttm',  editable: true, title: '메뉴 접근 일시',  width: this.setPercentage("divWrapper",20)},
      ]
      this.gridDataSelect();
    },
