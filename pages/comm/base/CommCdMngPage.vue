      ...
      <v-col :cols="4">
        <kcard ref="gridCard" :style="{height : '100%'}">
          <cardBody>
            ...
            <CardTitle>{{$t('CommCdMngPage.label5')}}</CardTitle>
            <div>
      ...
      <v-col :cols="8">
        <kcard :style="{height : '100%'}">
          <cardBody :style="{width:'100%'}">
            <CardTitle>{{$t('CommCdMngPage.label6')}}</CardTitle>
            <TabStrip :selected="selected" @select="onSelect" :tabs="tabs">
              ...
              <template v-slot:commCdTab>
                <div>
                <div class="d-flex align-center justify-space-between pa-2">
                  <CardTitle>{{$t('CommCdMngPage.label7')}}</CardTitle>
                  <div>
                    <kbutton :theme-color="'primary'" @click="insert2">{{$t('CommLang.btn.addBtn')}}</kbutton>
                    <kbutton :theme-color="'primary'" @click="remove2">{{$t('CommLang.btn.removeBtn')}}</kbutton>
                    <kbutton :theme-color="'primary'" @click="rowGridSave2">{{$t('CommLang.btn.saveBtn')}}</kbutton>
                  </div>
                </div>
                <div ref="divWrapper2">
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [
          {
            title: this.$i18n.t('CommCdMngPage.label1'),
            content: 'grpCdInfoTab',
          },
          {
            title: this.$i18n.t('CommCdMngPage.label3'),
            content: 'commCdTab',
          }
      ],
      gridDropDownList:[
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        { field: 'commGrpCd', editable: false, title: this.$i18n.t('CommCdMngPage.label1'),   width: this.setPercentage("divWrapper",30), cell:"crudCellTemplate"},
        { field: 'commGrpNm', editable: false, title: this.$i18n.t('CommCdMngPage.label2'), width: this.setPercentage("divWrapper",40)},
        { field: 'useFg',     editable: false, title: this.$i18n.t('CommLang.label.label7'),    width: this.setPercentage("divWrapper",20)}
      ];

      this.columns2 = [
        { field: 'commGrpCd',     editable: true, title: this.$i18n.t('CommCdMngPage.label1'),     width: this.setPercentage("divWrapper",20), cell:"crudCellTemplate"},
        { field: 'commCd',        editable: true, title: this.$i18n.t('CommCdMngPage.label3'),        width: this.setPercentage("divWrapper",30)},
        { field: 'commCdNm',      editable: true, title: this.$i18n.t('CommCdMngPage.label4'),      width: this.setPercentage("divWrapper", 50)},
        { field: 'sortSeq',       editable: true, title: this.$i18n.t('CommCdMngPage.label8'),     width: this.setPercentage("divWrapper",20)},
        { field: 'useFg',         editable: true, title: this.$i18n.t('CommCdMngPage.label8'),     width: this.setPercentage("divWrapper", 30), cell:'useFg'},
        { field: 'rmrk',          editable: true, title: this.$i18n.t('CommLang.label.label1'),        width: this.setPercentage("divWrapper", 50)},
      ]
