      ...
      <v-col :cols="4">
        <kcard ref="gridCard" :style="{height : '100%'}">
          <cardBody>
            ...
            <CardTitle>{{$t('DeptMngPage.label1')}}</CardTitle>
            <div>
      ...
      <v-col :cols="8">
        <kcard :style="{height : '100%'}">
          <cardBody :style="{width:'100%'}">
            <CardTitle>{{$t('DeptMngPage.label2')}}</CardTitle>
            <div>
              <v-row>
                <v-col :cols="6">
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        ...
        { field: 'name',  editable: false, title: this.$i18n.t('DeptMngPage.label5'), width: this.setPercentage("divWrapper",78),  expandable: true,},
      ];
      this.gridDataSelect();
    },
