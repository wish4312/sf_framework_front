        ...
        <Card>
          ...
          <v-row>
            ...
            <v-col :cols="8" class="text-right">
                <Button :theme-color="'primary'" @click="search">{{$t('CommLang.btn.selectBtn')}}</Button>
            </v-col>
          </v-row>
          </CardBody>
        </Card>
    ...
    <v-row ref="contents">
      ...
      <v-col :cols="8">
        <Card :style="{height : '100%'}">
          <CardBody>
            <div class="d-flex align-center justify-space-between pa-2">
              <CardTitle>{{$t('CalendarMngPage.label3')}}</CardTitle>
            </div>
...
export default {
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        { field: 'dt',  editable: false, title: this.$i18n.t('CalendarMngPage.label4'), width: this.setPercentage("divWrapper",25), cell:"crudCellTemplate", className: "gridTextCenter"  },
        { field: 'dtNm', editable: false, title: this.$i18n.t('CalendarMngPage.label5'),   width: this.setPercentage("divWrapper",10), className: "gridTextCenter"},
        { field: 'hldyFg', editable: true, title: this.$i18n.t('CalendarMngPage.label6'), width: this.setPercentage("divWrapper",25), cell:'hldyFg', className: "gridTextCenter"},
        { field: 'hldyNm',     editable: true, title: this.$i18n.t('CalendarMngPage.label7'),    width: this.setPercentage("divWrapper",35), className: "gridTextLeft"}
      ];
    },
