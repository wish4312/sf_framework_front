...
export default {
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        { field: 'prgmId',  editable: false, title: '프로그램ID', width: this.setPercentage("divWrapper",25), cell:"crudCellTemplate"},
        { field: 'prgmNm', editable: false, title: '프로그램명',   width: this.setPercentage("divWrapper",25)},
        { field: 'prgmTpCdNm', editable: false, title: '타입', width: this.setPercentage("divWrapper",25)},
        { field: 'useFg', editable: false, title: '사용여부', width: this.setPercentage("divWrapper",25)}
      ];
      this.gridDataSelect();
    },
