      ...
      <v-col :cols="4">
        <kcard ref="gridCard" :style="{height : '100%'}">
          <cardBody>
            ...
            <CardTitle>{{$t('RoleMngPage.label3')}}</CardTitle>
            <div>
      ...
      <v-col :cols="8">
        <kcard :style="{height : '100%'}">
          <cardBody :style="{width:'100%'}"> 
            <CardTitle>{{$t('RoleMngPage.label4')}}</CardTitle>
                <div>
                    <v-row>
                      <v-col :cols="6">
                        <v-row class="search-box" align="center" no-gutters>
...
export default {
  ...
  data() {
    return {
      ...
      gridHeight : '0px',
      gridData : [],
      label1 : this.$i18n.t('RoleMngPage.label1'),
      label2 : this.$i18n.t('RoleMngPage.label2')
    };
  },
  computed: {
    gridItems() {
  ...
  methods: {
    ...
    gridInit(){
      this.columns = [
        { field: 'roleId',  editable: false, title: this.label1, width: this.setPercentage("divWrapper",48), cell:"crudCellTemplate"},
        { field: 'roleNm', editable: false, title: this.label2,   width: this.setPercentage("divWrapper",48)},
        // { field: 'roleId',  editable: false, title: '권한코드', width: this.setPercentage("divWrapper",48), cell:"crudCellTemplate"},
        // { field: 'roleNm', editable: false, title: '권한명',   width: this.setPercentage("divWrapper",48)},
        // { field: 'useFg', editable: false, title: '사용여부', width: this.setPercentage("divWrapper",33)},
      ];
      this.gridDataSelect();
    },
